    ...
    return(
        <div className="container">
            <div className="image">
                ...
                <h3> $1.29 </h3>
                <a onClick={() => props.addCart('SimpleandCleanMP3')} className="addtocart cart1" href="#">Add to Cart</a>
            </div>
            <div className="image">
                <img src={BTMMP3} alt="Beneath The Mask MP3" />
                <h3> Beneath The Mask </h3>
                <h3> $1.29 </h3>
                <a onClick={() => props.addCart('BeneathTheMaskMP3')} className="addtocart cart2" href="#">Add to Cart</a>
            </div>
            <div className="image">
                <img src={MRMP3} alt="Mario Rap MP3" />
                <h3> Mario Rap </h3>
                <h3> $1.29 </h3>
                <a onClick={() => props.addCart('MarioRapMP3')} className="addtocart cart3" href="#">Add to Cart</a>
            </div>
            <div className="image">
                <img src={FRST} alt="Flying Raccoon Suit T-Shirt" />
                <h3> Flying Raccoon Suit T-Shirt </h3>
                <h3> $20.00 </h3>
                <a onClick={() => props.addCart('FlyingRaccoonSuitTshirt')} className="addtocart cart4" href="#">Add to Cart</a>
            </div>
            <div className="image">
                <img src={FRSTT} alt="Flying Raccoon Suit Tank" />
                <h3> Flying Raccoon Suit Tank </h3>
                <h3> $20.00 </h3>
                <a onClick={() => props.addCart('FlyingRacoonSuitTank')} className="addtocart cart5" href="#">Add to Cart</a>
            </div>
            <div className="image">
                <img src={FRSAG} alt="Flying Raccoon Suit Vinyl 'Afterglow' " />
                <h3> Flying Raccoon Suit Vinyl 'Afterglow' </h3>
                <h3> $20.00 </h3>
                <a onClick={() => props.addCart('FlyingRacoonSuitVinyl')} className="addtocart cart6" href="#">Add to Cart</a>
            </div>
        </div>
    )
}
